    ...
    >
      ...
      <div className="flex-1" style={{ overflowY: snap === "full" ? "auto" : "hidden", touchAction: "pan-y" }}>
        ...
        <div className="p-4 space-y-4">
          {isAdmin ? (
            <div className="rounded-lg border border-violet-300 dark:border-violet-700 bg-violet-50 dark:bg-violet-950/30 px-3 py-2 flex items-center gap-3">
              ...
              {categoryEditing ? (
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-between gap-2 rounded-md px-2 py-1 hover:bg-violet-100 dark:hover:bg-violet-900/40 transition-colors text-left"
                >
