    ...
    >
      ...
      <div className="flex-1" style={{ overflowY: "auto", touchAction: "pan-y" }}>
        ...
        <div className="p-4 space-y-4">
          ...
          {localVerified && place.category !== "station_carburant" && <div className="rounded-lg border-2 border-green-300 bg-green-50 dark:bg-green-950/30 dark:border-green-800 p-3 space-y-2">
